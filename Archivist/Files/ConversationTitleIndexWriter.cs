...
internal sealed class ConversationTitleIndexWriter : IConversationIndexWriter
{
    ...
    public ConversationTitleIndexWriter(IFileSystem fileSystem, IChatMetadataReader metadataReader)
    {
        _fileSystem = fileSystem ?? throw new ArgumentNullException(nameof(fileSystem));
        _displayNameProvider = new ConversationDisplayNameProvider(metadataReader);
    }

    /// <summary>Перестраивает индекс разговоров для указанного каталога.</summary>
    ...
    public void Refresh(string directory)
    {
        ...
        _ = contents.AppendLine(); _ = contents.AppendLine("## Conversations"); _ = contents.AppendLine();
